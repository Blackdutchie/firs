...
industry.add_spritelayout(
    id="field_coal_spritelayout_1",
    tile="field_coal_tile_1",
    ground_sprite=None,
    ground_overlay=None,
...
industry.add_industry_layout(
    id="field_coal_industry_layout_1",
    layout=[
        (0, 0, "field_coal_spritelayout_8"),
        (0, 1, "field_coal_spritelayout_6"),
        (0, 2, "field_coal_spritelayout_3"),
        (1, 0, "field_coal_spritelayout_5"),
        (1, 1, "field_coal_spritelayout_4"),
        (1, 2, "field_coal_spritelayout_6"),
        (2, 0, "field_coal_spritelayout_10"),
        (2, 1, "field_coal_spritelayout_5"),
        (2, 2, "field_coal_spritelayout_8"),
        (3, 1, "field_coal_spritelayout_2"),
    ],
)

industry.add_industry_layout(
    id="field_coal_industry_layout_2",
    layout=[
        (0, 0, "field_coal_spritelayout_5"),
        (0, 1, "field_coal_spritelayout_8"),
        (0, 2, "field_coal_spritelayout_10"),
        (1, 0, "field_coal_spritelayout_6"),
        (1, 1, "field_coal_spritelayout_4"),
        (1, 2, "field_coal_spritelayout_5"),
        (1, 3, "field_coal_spritelayout_2"),
        (2, 0, "field_coal_spritelayout_8"),
        (2, 1, "field_coal_spritelayout_6"),
        (2, 2, "field_coal_spritelayout_3"),
    ],
)

industry.add_industry_layout(
    id="field_coal_industry_layout_3",
    layout=[
        (0, 0, "field_coal_spritelayout_8"),
        (0, 1, "field_coal_spritelayout_3"),
        (0, 2, "field_coal_spritelayout_10"),
        (1, 0, "field_coal_spritelayout_6"),
        (1, 1, "field_coal_spritelayout_4"),
        (1, 2, "field_coal_spritelayout_8"),
        (2, 0, "field_coal_spritelayout_6"),
        (2, 1, "field_coal_spritelayout_5"),
        (2, 2, "field_coal_spritelayout_5"),
        (2, 3, "field_coal_spritelayout_2"),
    ],
)