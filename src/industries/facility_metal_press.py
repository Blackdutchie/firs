...
industry = IndustrySecondary(
    ...
    name="string(STR_IND_FACILITY_METAL_PRESS)",
...
industry.add_tile(
    id="facility_metal_press_tile_1",
...
industry.add_spritelayout(
    id="facility_metal_press_spritelayout_empty",
    tile="facility_metal_press_tile_1",
...
industry.add_spritelayout(
    id="facility_metal_press_spritelayout_tanks",
    tile="facility_metal_press_tile_1",
    ground_sprite=spriteset_ground,
...
industry.add_spritelayout(
    id="facility_metal_press_spritelayout_air_plant",
    tile="facility_metal_press_tile_1",
    ground_sprite=spriteset_ground,
    ground_overlay=None,
...
industry.add_spritelayout(
    id="facility_metal_press_spritelayout_furnace",
    tile="facility_metal_press_tile_1",
    ground_sprite=spriteset_ground,
    ground_overlay=None,
...
industry.add_spritelayout(
    id="facility_metal_press_spritelayout_casting_shed",
    tile="facility_metal_press_tile_1",
    ground_sprite=spriteset_ground,
    ground_overlay=None,
...
industry.add_spritelayout(
    id="facility_metal_press_spritelayout_metal_with_small_train_car_1",
    tile="facility_metal_press_tile_1",
    ground_sprite=spriteset_ground,
    ground_overlay=None,
...
industry.add_spritelayout(
    id="facility_metal_press_spritelayout_small_shed",
    tile="facility_metal_press_tile_1",
    ground_sprite=spriteset_ground,
    ground_overlay=None,
...
industry.add_spritelayout(
    id="facility_metal_press_spritelayout_metal_1",
    tile="facility_metal_press_tile_1",
    ground_sprite=spriteset_ground,
    ground_overlay=None,
...
industry.add_spritelayout(
    id="facility_metal_press_spritelayout_metal_2",
    tile="facility_metal_press_tile_1",
    ground_sprite=spriteset_ground,
    ground_overlay=None,
...
industry.add_spritelayout(
    id="facility_metal_press_spritelayout_metal_3",
    tile="facility_metal_press_tile_1",
    ground_sprite=spriteset_ground,
    ground_overlay=None,
...
industry.add_spritelayout(
    id="facility_metal_press_spritelayout_metal_4",
    tile="facility_metal_press_tile_1",
    ground_sprite=spriteset_ground,
    ground_overlay=None,
...
industry.add_industry_layout(
    id="facility_metal_press_industry_layout_1",
    layout=[
        (0, 0, "facility_metal_press_spritelayout_casting_shed"),
        (0, 1, "facility_metal_press_spritelayout_tanks"),
        (1, 0, "facility_metal_press_spritelayout_furnace"),
        (1, 1, "facility_metal_press_spritelayout_small_shed"),
        (2, 0, "facility_metal_press_spritelayout_casting_shed"),
        (2, 1, "facility_metal_press_spritelayout_metal_1"),
    ],
)